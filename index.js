      ...
      .updateOne(
        { _id: id },
        {
          $set: {
            ...
            answer7dot1dot1: answers.ans7dot1dot1,
            answer8dot1: answers.ans8dot1,
            answer8dot2: answers.ans8dot2,
      ...
      .updateOne(
        { _id: id },
        {
          $set: {
            ...
            answer7dot1dot1: update.answer7dot1dot1,
            answer8dot1: update.answer8dot1,
            answer8dot2: update.answer8dot2,
